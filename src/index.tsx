...
import { CustomWidgetProps, CustomWidget } from "./custom-widget";
...
const factory: BlockFactory = (BaseBlockClass, _widgetApi) => {
  /**
   *  <custom-widget message="world!"></custom-widget>
   */
  return class CustomWidgetBlock extends BaseBlockClass implements BaseBlock {
    public constructor() {
      super();
    }

    private get props(): CustomWidgetProps {
      const attrs = this.parseAttributes<CustomWidgetProps>();
      return {
        ...attrs,
    ...
    public renderBlock(container: HTMLElement): void {
      ReactDOM.render(<CustomWidget {...this.props} />, container);
    }
